...
class RegistrationWindow(BaseWindow):
    def __init__(self):
        ...
        inp_user_name_x, inp_user_name_y = self.size[0] / 10 * 3.7, self.size[1] / 6
        inp_password_x, inp_password_y = self.size[0] / 10 * 1.7, self.size[1] / 6 * 2
        inp_proof_password_x, inp_proof_password_y = self.size[0] / 10 * 5.7, self.size[1] / 6 * 2
